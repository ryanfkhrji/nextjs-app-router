    ...
    <div className="mx-auto my-5 p-6">
      <div className="lg:w-1/2 mx-auto">
        ...
        <div className="flex justify-center items-center gap-4 bg-white shadow-md rounded-lg p-4 border border-gray-300">
          ...
          <div>
            <h5 className="text-lg font-medium tracking-tight text-gray-900 dark:text-white">{product.data.title}</h5>
            <p className="text-sm text-gray-400 dark:text-gray-400 mb-3">Category: {product.data.category}</p>
            <p className="text-sm text-gray-400 dark:text-gray-400 mb-4">Description: {product.data.description}</p>
